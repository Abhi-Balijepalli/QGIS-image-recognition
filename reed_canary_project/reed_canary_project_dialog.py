...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'reed_canary_project_dialog_base.ui'))


class ReedCanaryProjectDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(ReedCanaryProjectDialog, self).__init__(parent)
